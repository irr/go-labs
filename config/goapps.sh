...
tar xfva etcd-v2.0.0-rc.1-linux-amd64.tar.gz
rm -rf etcd; ln -s etcd-v2.0.0-rc.1-linux-amd64 etcd
...
tar xfva nsq-0.3.0.linux-amd64.go1.3.3.tar.gz
rm -rf nsq;ln -s nsq-0.3.0.linux-amd64.go1.3.3 nsq
